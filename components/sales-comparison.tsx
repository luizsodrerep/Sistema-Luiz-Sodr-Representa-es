...
export function SalesComparison({
  ...
  const filteredData = salesData.filter((sale) => {
    ...
    if (
      representadaId &&
      sale.representadaId !== representadaId
    ) {
      return false
    }
    ...
    if (
      selectedRepresentada !== "all" &&
      sale.representadaId !== selectedRepresentada
    ) {
      return false
    }
  ...
  const totalPercentageDifference =
    totals.soldValue > 0
      ? (totals.difference / totals.soldValue) * 100
      : 0
  ...
  const representadas = [
    {
      id: "premium123",
      name: "Descartáveis Premium Ltda",
    },
    {
      id: "eco456",
      name: "Embalagens Eco Ltda",
    },
    {
      id: "papel789",
      name: "Papel & Cia",
    ...
    <Card>
      <CardHeader className="pb-3">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <CardTitle>
              Comparação de Valores: Vendido vs. Faturado
            </CardTitle>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <Select
              ...
              onValueChange={setSelectedRepresentada}
            >
            ...
            {filteredData.map((sale) => (
              <TableRow key={sale.id}>
                ...
                {!representadaId && (
                  <TableCell>
                    <Link
                      href={`/representadas/${sale.representadaId}`}
                      className="text-primary hover:underline"
                    >
                      {sale.representada}
                    </Link>
