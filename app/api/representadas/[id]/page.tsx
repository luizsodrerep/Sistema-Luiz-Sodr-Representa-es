      ...
      <div className="space-y-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="mb-2">
              <p className="text-sm text-muted-foreground">Comissao Fixa</p>
              <p className="font-medium text-lg">{rep.comissao ? rep.comissao + "%" : "Nao definida"}</p>
            </div>
            <div className="border-t pt-3">
              <p className="text-sm font-medium mb-3">Comissao Variavel por Faixa de Desconto</p>
              <div className="grid grid-cols-3 gap-2 text-xs font-medium text-muted-foreground px-2 mb-1">
