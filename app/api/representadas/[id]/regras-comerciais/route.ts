...
export async function POST(
  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        {
          message: "Nome da regra comercial é obrigatório.",
        },
        { status: 400 }
      )
    }
    ...
    try {
      ...
      prazoFaturamentoDias =
        parseNumeroOpcional(body.prazoFaturamentoDias)
    ...
    if (
      ...
      (!Number.isInteger(prazoFaturamentoDias) ||
