      ...
      <div className="flex-1 space-y-4 p-8 pt-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="ml-2 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-blue-100 text-blue-800">
              {usuario.cargo}
            </div>
          </div>
          <div className="flex items-center gap-2">
          ...
          <TabsContent value="atividades" className="space-y-4">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { data: "15/03/2023 14:30", acao: "Login no sistema", ip: "189.123.45.67" },
                    { data: "15/03/2023 14:35", acao: "Visualização de representada", ip: "189.123.45.67" },
                    { data: "15/03/2023 15:10", acao: "Atualização de meta", ip: "189.123.45.67" },
                    { data: "14/03/2023 09:45", acao: "Geração de relatório", ip: "189.123.45.67" },
                    { data: "14/03/2023 11:20", acao: "Cadastro de cliente", ip: "189.123.45.67" },
                  ].map((atividade, i) => (
